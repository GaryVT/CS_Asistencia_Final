<template>
    <div>
      ...
      <div>
        <br>
        <v-btn v-on:click='open'> Open </v-btn>
    ...
    <v-text-field
                        ...
                        label="Dni"
                        outline
                        style="margin: auto; display:grid; margin-right: 600px; margin-left: 600px;"
  ...
  export default {
      ...
      methods: {
        editarhorario() {
              alert("No existe Curso con esa Hora")
            },
          stop() {
          ...
          snap(){
            ...
            data.append('data', this.usuario.dni)
           
  
            axios.post('http://127.0.0.1:5050/test', data)
              .then(function(data){
